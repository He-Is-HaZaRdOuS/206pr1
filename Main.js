...
function addLectureHall(hallInfo) {
  ...
  // both values were integers or both were non-integers
    ...
    return false; // ask user again for inputs
  }
}
          ...
          if (cnt == 4) {
            ...
            if (flag != 0) {
              ...
              */
              ...
              let errorString = "Unsufficient classrooms, please enter id and capacity of atleast ";  // pass this string to getNewClassroom(); function
              do{ // loop till new data is correct

                let data = await getNewClassroom(wantedCapacity);
                dataIsValid = addLectureHall(data);
                // if entered data is invalid, then update string and loop till valid lecture hall data is entered
                errorString = "The info you entered were invalid, please enter the id and capacity of the classroom"
